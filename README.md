...
### 中文
2026-06-02 AIGC 工作流归档：把飞书会议纪要整理成静态复盘页，沉淀流程、工具和实践线索。

### English
AIGC workflow archive that turns meeting minutes into a static review page for processes, tools, and practice notes.
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/2026-06-02-aigc-workflow-obcnyp9p
- Live / 在线入口：https://siuserxiaowei.github.io/2026-06-02-aigc-workflow-obcnyp9p/
...
```bash
git clone https://github.com/siuserxiaowei/2026-06-02-aigc-workflow-obcnyp9p.git
cd 2026-06-02-aigc-workflow-obcnyp9p
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnyp9p9zeakc7dqugca8on
- 模板：one_page
- 页面：`docs/index.html`
